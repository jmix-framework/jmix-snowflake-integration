package com.company.snowflake.test_support;

import com.company.snowflake.SnowflakeIntegration153Application;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.snowflake.screen")
@ContextConfiguration(classes = {SnowflakeIntegration153Application.class, UiTestAssistConfiguration.class})
